...
<div class="RightSide">
    <div class="bredCrum">
        <h4><a href="index.html">Home</a>   >>  <a href="#" class="select"> Your Shopping Cart  </a> </h4>
    </div>
    <div class="cartDetail">
        <div class="headings">
            <ul>
                ...
                <li class="quanitity">QUANTITY</li>
...
%>
        <div class="totalShiping">
            <div class="txtTotal"><h4>TOTAL PRICE  =</h4></div>
    ...
    <div class="paging">
        ...
        <div class="pagingInfo"><h4><a href="produits.jsp" title="CONTINUE SHOPPING">CONTINUE</a></h4></div>
        <div class="clr"></div> 
    </div>
</div>
