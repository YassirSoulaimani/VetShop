...
<div class="RightSide">
      ...
      <div class="bredCrum" style="margin-bottom:38px;">
        <h4><a href="index.html">Accueil</a>   >>   <a href="#" class="select">Categorie</a> >>   <a href="#" class="select">Chaussures</a> </h4>
      </div>
    <% 
            ...
            Vector<Article> articles = dao.findAllwitCategorie(2);
...
%>
   ...
   <% 
        ...
        %>
          ...
          <li class="<%= cls %>">
              <div class="catThum">
                  <a href="product.jsp?id=<%= articles.get(i).getIdArticle() %>">
...
<%}%>
            ...
            <div class="catDetail">
              <h4><a href="product.jsp?id=<%= articles.get(i).getIdArticle() %>"><%= articles.get(i).getLibelle() %> </a></h4>
