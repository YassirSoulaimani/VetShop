...
for(LignePanier lp : panier.getLignesPanier())
    prixT += lp.getQuantite()*lp.getArticle().getPrix(); %>
        ...
        <li class="notification"><a href="panier.jsp">Shopping cart
            <span class="badge"><%= panier.getNumberArticle() %></span>
        </a></li>
        <li class="cart-value">
            <span class="blue"><a href="panier.jsp"><%= panier.getNumberArticle() %> Products</a></span> |  <img src="images/dollar-currency-symbol.png"> <b> <span style=font-size:150%;"><%= prixT %></span></b></li>
      </ul>
    </div>
    <!-- end div #TopContent -->
    <div id="Nav">
      <div class="NavBody">
        <ul >
            ...
            <li> <a href="produits.jsp">Our products</a></li>
  ...
  <div id="Content">
    <div class="LeftSide">
        ...
        <% if(session.getAttribute("client") == null){ %>
            <div class="leftBox">
              <h3><p style= "margin-left: 62px ; margin-bottom: 12px">Login</h3>
              ...
              <ul class="cat-link" style="margin-top:-20px">
                  ...
                  <li> Password : 	<input type="password" name="mdp" style="width:100%" /> </li>
                  </ul>
                  <a href="registerClient.jsp" style="margin:5px"> Register</a>
                 <input style="margin-left:20px;margin-right:-20px;" type="submit" value="Validate" />
                      </form>
              </div>
            </div>
        <% }else{ %>
            <div class="leftBox">
                <h3><p style= "margin-left: 50px ; margin-bottom: 10px">Welcome</h3>

                <div class="leftBoxBody">
                    <p style="margin-top: -5px; margin-left: -10px ">Welcome <b> <%= ((Client)session.getAttribute("client")).getNom()  %></b></p>
              <ul class="cat-link" >
                  <li> <a href="myaccount.jsp"> My account </a> </li>
                  <li> <a href="panier.jsp"> Cart </a> </li>
                  <li> <a href="myorders.jsp"> My orders </a> </li>
                  <li> <a href="DeconnexionServlet"> Logout.. </a> </li>
                  </ul>
              </div>
            </div>
        <% } %>
        ...
        <!-- categorie--->
      <div class="leftBox">
        <h3><p style= "margin-left: 50px ; margin-bottom: 10px">Category</h3>
        <div class="leftBoxBody">
          <ul class="sellerlist">

                <li><span></span>
                    <p><a href=" Clothes.jsp? " id="1" >Clothes</a></p>
                    <div class="clr"></div>
                </li>
              <li><span></span>
                  <p><a href=" Shoes.jsp? id= 2 ">Shoes</a></p>
                  <div class="clr"></div>
              </li>
              <li><span></span>
                  <p><a href=" Accessoires.jsp? id= 3 ">Accessories</a></p>
                  <div class="clr"></div>
              </li>
          </ul>
          <div class="clr"></div>
