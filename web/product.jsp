...
<div class="RightSide">     
    ...
    <div class="bredCrum">
        <h4><a href="index.html">Home</a>   >>   <a href="#" class="select"> <%= article.getLibelle() %></a></h4>
    </div>
    <div class="productDetial">
        ...
        <div class="rightProduct">
            ...
            <div class="cartBtn fl">
                <a href="PanierServlet?op=add&sender=product.jsp&id=<%= id %>" title="ADD to Cart" class="addToCart"></a>
            </div>
            <div class="clr"></div>	
        </div>
    </div>
    <div class="detailInfo">
        <h2>Item details : </h2>
        <p> <%= article.getDesc() %> </p>
        <p class="add">This product is added on <%= article.getDateAjout()  %></p>
    </div>
    ...
    <div class="paging">
        ...
        <div class="pagingInfo">
            ...
            <a href="PanierServlet?op=add&sender=product.jsp&id=<%= id %>">Add to Cart</a>
        </div>
